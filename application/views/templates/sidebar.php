...
<nav class="md:hidden fixed bottom-0 left-0 w-full bg-white dark:bg-dark-card border-t dark:border-gray-700 py-2 px-0 z-40 grid grid-cols-3 transition-colors">
    <?php $isActive = ($this->uri->segment(1) == 'dashboard'); ?>
